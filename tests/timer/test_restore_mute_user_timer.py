...
from timermute.timer.restore import MuteUserRestoreTimer, RestoreTimerBase
...
class TestMuteUserRestoreTimer(unittest.TestCase):
    ...
    def test_set(self):
        ...
        mock_mute_user_unmute_timer = self.enterContext(patch("timermute.timer.restore.MuteUserUnmuteTimer"))
