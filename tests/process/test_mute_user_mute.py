...
from timermute.process.mute_user_mute import MuteUserMute
...
class TestMuteUserMute(unittest.TestCase):
    def test_run(self):
        ...
        self.enterContext(patch("timermute.process.mute_user_mute.print"))
        self.enterContext(patch("timermute.process.mute_user_mute.logger.info"))
        mock_muter = self.enterContext(patch("timermute.process.mute_user_mute.Muter"))
        mock_popup_get_interval = self.enterContext(patch("timermute.process.mute_user_mute.popup_get_interval"))
        mock_mute_user_unmute_timer = self.enterContext(patch("timermute.process.mute_user_mute.MuteUserUnmuteTimer"))
